...
def get_thuviencine_top():
    """Hàm chính để lấy danh sách phim hot từ thuviencine.live/top"""
    log("Đang lấy danh sách phim hot từ thuviencine.live/top")
    ...
    next_page_url = "https://thuviencine.live/top/page/2/"
    nextpage = {
