...
ADDON_PATH = 'special://home/addons/plugin.video.vietmediaF2'
    ...
    menu_items = [
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=advanced_settings_menu",
            "is_playable": False,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=install_arctic_zephyr",
            "is_playable": False,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=install_vmf_source",
            "is_playable": False,
            "thumbnail": install_skin_icon,
            "icon": install_skin_icon,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=subtitle_fonts",
            "is_playable": False,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=__showdownload__",
            "is_playable": False,
        ...
        {
            "label": "Xóa Cache",
            "path": "plugin://plugin.video.vietmediaF2?action=clearCache",
            "is_playable": False,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=__backup__",
            "is_playable": False,
        ...
        },
        {
            ...
            "path": "plugin://plugin.video.vietmediaF2?action=__restore__",
            "is_playable": False,
        ...
        {
            "label": "Vùng cấm",
            "path": "plugin://plugin.video.vietmediaF2?action=__forbiddenZone__",
            "is_playable": False,
        ...
        {
            "label": "Thoát KODI",
            "path": "plugin://plugin.video.vietmediaF2?action=__exitKodi__",
            "is_playable": False,
    ...
    try:
        ...
        for key, value in info.items():
            ...
            if k == 'title':
                ...
                info_tag.setOriginalTitle(str(value))
            elif k == 'plot':
                info_tag.setPlot(str(value))
            elif k == 'year':
                try:
