...
def getdata(url):
    ...
    if nd["table"]["cols"]:
        ...
        playable = not (("folder" in link or "menu" in link or "docs.google.com" in link or "m3uhttp" in link or "thuviencine" in link or "thuvienhd" in link or "hdvietnam" in link) or \
    ...
    for link in js:
        ...
        playable = not (("folder" in link or "docs.google.com" in link or "pastebin.com" in link or "m3uhttp" in link or "menu" in link or "thuviencine" in link or "thuvienhd" in link or "hdvietnam" in link) or ("4share.vn" in link and "/d/" in link) or ("api.4share.vn" in link and "/d/" in link))
