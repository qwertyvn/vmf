...
def list_subtitle_fonts():
    ...
    for font in fonts:
        item = {
            "label": font,
            "is_playable": False,
            "path": f"plugin://plugin.video.vietmediaF2?action=install_subtitle_font&font={font}",
            "thumbnail": "special://home/addons/plugin.video.vietmediaF2/resources/images/settings.png",
            "icon": "special://home/addons/plugin.video.vietmediaF2/resources/images/settings.png",
            "label2": "",
