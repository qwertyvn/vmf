...
CUSTOM_ICONS_DIR = os.path.join(xbmcvfs.translatePath('special://home/addons/plugin.video.vietmediaF2/resources/images/custom'))
...
def get_default_icon(position):
    ...
    return os.path.join(xbmcvfs.translatePath('special://home/addons/plugin.video.vietmediaF2/resources/images'), 'default.png')
